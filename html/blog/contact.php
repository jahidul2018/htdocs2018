...
<?php 
 ...
 ?>
		...
		/*<div class="readmore clear">
					<a href="hire.php?product_id=<?php echo $result['product_id']; ?>">Order and hire tailor</a> <br>
					<a href="contact.php?product_id=<?php echo $result['product_id']; ?>">customize shirt</a>
		</div> <br> <br> <br> */
