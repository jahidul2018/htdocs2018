		...
		<main>
			...
			<div class="content2">
				...
				<?php
					...
					$res=mysql_query("SELECT * FROM Art WHERE Medium='airbrush' AND AdminClearance='Allowed' limit $per_page, 12") or die(mysql_error());
					...
					$res1=mysql_query("SELECT * FROM Art WHERE Medium='airbrush' AND AdminClearance='Allowed'");
