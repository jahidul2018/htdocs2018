...
<?php
	...
	if($rows==1){
		while($fetch=mysql_fetch_assoc($result)){
			$artist_guide=$fetch['ArtistGuide'];
...
<?php
	...
	if(isset($_POST['done'])){
		...
		$query = "Update User_Guide Set ArtistGuide = '$aguide' Where ID = 'admin'";
		...
		if(!$result){
			...
			header("location: artist_guide.php");
		}
	}
		...
		<main>
			...
			<div class="UsersGuide">
							...
							<form method="post" action="" name="UserGuide">
								...
								<label>Artist Guidelines</label><br>
								<textarea type="text" id="artist_guide" name="artist_guide" maxlength="30000" disabled><?php echo $artist_guide; ?></textarea>
								...
								<script type='text/javascript'>
										function updateUguide(){
											...
											document.UserGuide.artist_guide.disabled = false;
											...
											document.UserGuide.artist_guide.style.border = "2px solid #9E9E9E";
											document.UserGuide.artist_guide.style.background = "#FFFFFF";
										}
								...
								<script type='text/javascript'>
										function validate(){
											...
											var aguide = document.UserGuide.artist_guide;
