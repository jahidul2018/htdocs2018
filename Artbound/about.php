...
<?php
	...
	if(isset($_POST['done'])){
		...
		$query = "Update User_Guide Set About = '$about2' Where ID = 'admin'";
		...
		<main>
			...
			<div class="UsersGuide">
							...
							<form method="post" action="" name="UserGuide">
								...
								<textarea type="text" name="about" maxlength="30000" disabled><?php echo $about; ?></textarea>
								...
								<script type='text/javascript'>
										function updateUguide(){
											...
											document.UserGuide.about.disabled = false;
											...
											document.UserGuide.about.style.border = "2px solid #9E9E9E";
											document.UserGuide.about.style.background = "#FFFFFF";
										}
								...
								<script type='text/javascript'>
										function validate(){
											...
											var aguide = document.UserGuide.about;
