...
<?php
	...
	if($rows==1){
		while($fetch=mysql_fetch_assoc($result)){
			$member_guide=$fetch['MemberGuide'];
...
<?php
	...
	if(isset($_POST['done'])){
		...
		$query = "Update User_Guide Set MemberGuide = '$mguide' Where ID = 'admin'";
		...
		if(!$result){
			...
			header("location: member_guide.php");
		}
	}
		...
		<main>
			...
			<div class="UsersGuide">
							...
							<form method="post" action="" name="UserGuide">
								...
								<label>Member Guidelines</label><br>
								<textarea type="text" id="member_guide" name="member_guide" maxlength="30000" disabled><?php echo $member_guide; ?></textarea>
								...
								<script type='text/javascript'>
										function updateUguide(){
											...
											document.UserGuide.member_guide.disabled = false;
											...
											document.UserGuide.member_guide.style.border = "2px solid #9E9E9E";
											document.UserGuide.member_guide.style.background = "#FFFFFF";
										}
								...
								<script type='text/javascript'>
										function validate(){
											...
											var aguide = document.UserGuide.member_guide;
