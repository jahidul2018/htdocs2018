...
<?php
	...
	if(isset($_POST['done'])){
		...
		$query = "Update User_Guide Set ArtboundAim = '$aim2' Where ID = 'admin'";
		...
		<main>
			...
			<div class="UsersGuide">
							...
							<form method="post" action="" name="UserGuide">
								...
								<label>Aim of Artbound</label><br>
								<textarea type="text" id="aim" name="aim" maxlength="30000" disabled><?php echo $aim; ?></textarea>
								...
								<script type='text/javascript'>
										function updateUguide(){
											...
											document.UserGuide.aim.disabled = false;
											...
											document.UserGuide.aim.style.border = "2px solid #9E9E9E";
											document.UserGuide.aim.style.background = "#FFFFFF";
										}
								...
								<script type='text/javascript'>
										function validate(){
											...
											var aguide = document.UserGuide.aim;
