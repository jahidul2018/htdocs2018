...
<?php
	...
	if($rows==1){
		while($fetch=mysql_fetch_assoc($result)){
			$bidder_guide=$fetch['BidderGuide'];
...
<?php
	...
	if(isset($_POST['done'])){
		...
		$query = "Update User_Guide Set BidderGuide = '$bguide' Where ID = 'admin'";
		...
		if(!$result){
			...
			header("location: bidder_guide.php");
		}
	}
		...
		<main>
			...
			<div class="UsersGuide">
							...
							<form method="post" action="" name="UserGuide">
								...
								<label>Bidder Guidelines</label><br>
								<textarea type="text" id="bidder_guide" name="bidder_guide" maxlength="30000" disabled><?php echo $bidder_guide; ?></textarea>
								...
								<script type='text/javascript'>
										function updateUguide(){
											...
											document.UserGuide.bidder_guide.disabled = false;
											...
											document.UserGuide.bidder_guide.style.border = "2px solid #9E9E9E";
											document.UserGuide.bidder_guide.style.background = "#FFFFFF";
										}
								...
								<script type='text/javascript'>
										function validate(){
											...
											var aguide = document.UserGuide.bidder_guide;
