...
<?php
	...
	if($rows==1){
		while($fetch=mysql_fetch_assoc($result)){
			$collector_guide=$fetch['CollectorGuide'];
...
<?php
	...
	if(isset($_POST['done'])){
		...
		$query = "Update User_Guide Set CollectorGuide = '$cguide' Where ID = 'admin'";
		...
		if(!$result){
			...
			header("location: collector_guide.php");
		}
	}
...
<html lang="eng">
	<head>
		<title> Collector Guidelines </title>
		...
		<main>
			...
			<div class="UsersGuide">
							...
							<form method="post" action="" name="UserGuide">
								...
								<label>Collector Guidelines</label><br>
								<textarea type="text" id="collector_guide" name="collector_guide" maxlength="30000" disabled><?php echo $collector_guide; ?></textarea>
								...
								<script type='text/javascript'>
										function updateUguide(){
											...
											document.UserGuide.collector_guide.disabled = false;
											...
											document.UserGuide.collector_guide.style.border = "2px solid #9E9E9E";
											document.UserGuide.collector_guide.style.background = "#FFFFFF";
										}
								...
								<script type='text/javascript'>
										function validate(){
											...
											var aguide = document.UserGuide.collector_guide;
