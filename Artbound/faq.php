...
<?php
	...
	if(isset($_POST['done'])){
		...
		$query = "Update User_Guide Set FAQ = '$faq2' Where ID = 'admin'";
		...
		<main>
			...
			<div class="UsersGuide">
							...
							<form method="post" action="" name="UserGuide">
								...
								<label>FAQ</label><br>
								<textarea type="text" id="faq" name="faq" maxlength="30000" disabled><?php echo $faq; ?></textarea>
								...
								<script type='text/javascript'>
										function updateUguide(){
											...
											document.UserGuide.faq.disabled = false;
											...
											document.UserGuide.faq.style.border = "2px solid #9E9E9E";
											document.UserGuide.faq.style.background = "#FFFFFF";
										}
								...
								<script type='text/javascript'>
										function validate(){
											...
											var aguide = document.UserGuide.faq;
