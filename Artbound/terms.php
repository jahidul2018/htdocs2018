...
<?php
	...
	if(isset($_POST['done'])){
		...
		$query = "Update User_Guide Set TermService = '$term2' Where ID = 'admin'";
		...
		<main>
			...
			<div class="UsersGuide">
							...
							<form method="post" action="" name="UserGuide">
								...
								<textarea type="text" id="term" name="term" maxlength="30000" disabled><?php echo $term; ?></textarea>
								...
								<script type='text/javascript'>
										function updateUguide(){
											...
											document.UserGuide.term.disabled = false;
											...
											document.UserGuide.term.style.border = "2px solid #9E9E9E";
											document.UserGuide.term.style.background = "#FFFFFF";
										}
								...
								<script type='text/javascript'>
										function validate(){
											...
											var aguide = document.UserGuide.term;
