	...
	<body>
		<main>
			...
			<div class="all_artist">
				<h4>All Collectors</h4><hr/>
				
				<ul>
				<?php
						
						$query="SELECT * FROM users WHERE UserType='collector' ORDER BY FirstName ASC";
				...
				?>
						...
						<li><p>><a href="art_owner.php?UserID=<?php echo $user_id;?>"><?php echo $first_name.' '.$last_name; ?></a></p></li>
