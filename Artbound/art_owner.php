...
<html lang="eng">
	<head>
		<title><?php if($user_type=="artist"){ echo "Artist : ".$first_name." ".$last_name;} else{echo "Collector : ".$first_name." ".$last_name;}?> </title>
			...
			<div class="your_profile">
				...
				?>
					<div id="sidebar5">
						<ul id="mcd-menu2">
							<li>
								<a href="art_owner.php?UserID=<?php echo $user_id?>"  class="active">
									<img src="image/aboutme2.png"/>
									<strong>About Artist</strong>
									<small>Artist's short biography</small>
								</a>
							</li>
							<li>
								<a href="artworks.php?UserID=<?php echo $user_id?>">
									<img src="image/art1.png"/>
									<strong>Art Contents</strong>
									<small>Artist's artworks</small>
								</a>
							</li>
						...
						<ul id="mcd-menu2">
							<li>
								<a href="art_owner.php?UserID=<?php echo $user_id?>"  class="active">
									...
									<small>collector's biography</small>
								</a>
							</li>
							<li>
								<a href="artworks.php?UserID=<?php echo $user_id?>">
									...
									<small>all art collections</small>
								</a>
							</li>
					...
					<div class="user_intro">
						<?php
									if($user_image=="" && $about_user==""){
											echo "<p>No introduction is added yet.</p>";
									}
						...
						<div id="user_img">
							...
							<?php
									if($user_image==""){
											echo "<p>No profile picture is uploaded yet.</p>";
									}
						...
						<?php
								if($about_user==""){
									echo "<p style='margin-top:100px; text-align:justify; color:#FFCDD2; font-family:cambria; font-size:17px;'>No introduction is added yet.</p>";
								}
