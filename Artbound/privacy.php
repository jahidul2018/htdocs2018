...
<?php
	...
	if(isset($_POST['done'])){
		...
		$query = "Update User_Guide Set PrivacyPolicy = '$privacy2' Where ID = 'admin'";
		...
		<main>
			...
			<div class="UsersGuide">
							...
							<form method="post" action="" name="UserGuide">
								...
								<textarea type="text" id="privacy" name="privacy" maxlength="30000" disabled><?php echo $privacy; ?></textarea>
								...
								<script type='text/javascript'>
										function updateUguide(){
											...
											document.UserGuide.privacy.disabled = false;
											...
											document.UserGuide.privacy.style.border = "2px solid #9E9E9E";
											document.UserGuide.privacy.style.background = "#FFFFFF";
										}
								...
								<script type='text/javascript'>
										function validate(){
											...
											var aguide = document.UserGuide.privacy;
