...
<html lang="eng">
	<head>
		<title> Check Auction Requests </title>
		...
		<main>
			...
			<div class="content_auc">
				...
				<?php
					...
					$res=mysql_query("SELECT * FROM Art WHERE AuctionRequest>9 AND RequestStatus IS NULL limit $per_page, 5") or die(mysql_error());
					while($row=mysql_fetch_array($res))
					{
						...
						<div class="auction_img">
							<div id="auc_img">
								<img src="<?php echo "art/".$row["ArtImage"];?>"/>
							</div>
							<div id="auc_desc">
								...
								<p><strong>Total Requests :</strong> <?php echo $row["AuctionRequest"];?></p><br/>
								<p><strong>Requested By :</strong></p><br/>
								<div id="req_sender">
									<?php 
										$res2=mysql_query("SELECT * FROM auction_request WHERE ArtID='$art_id'") or die(mysql_error());
										while($row=mysql_fetch_array($res2))
										{
											...
											?>
												...
												<a href="check_users.php?User=<?php echo $userID;?>"> <?php echo $userName?></a><br/>
									...
									<a href="allow_auction.php?Art=<?php echo $art_id;?>"><input type="submit" name="allow" value="Allow Auction"/></a>
									<a href="cancel_auction.php?Art=<?php echo $art_id;?>"><input type="submit" name="cancel" value="Cancel Request"/></a>
					...
					$res1=mysql_query("SELECT * FROM art WHERE AuctionRequest>9");
