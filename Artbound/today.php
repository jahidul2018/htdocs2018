		...
		<main>
			...
			<div class="content2">
				...
				<?php
					...
					$res=mysql_query("SELECT * FROM Art WHERE UploadDay='$upload_day' AND UploadMonth='$upload_month' AND UploadYear='$upload_year' AND AdminClearance='Allowed' limit $per_page, 12") or die(mysql_error());
					...
					$res1=mysql_query("SELECT * FROM Art WHERE UploadDay='$upload_day' AND UploadMonth='$upload_month' AND UploadYear='$upload_year' AND AdminClearance='Allowed'");
