		...
		<main>
			...
			<div class="content3">
				...
				<?php
					...
					$res=mysql_query("SELECT * FROM Reports WHERE ReportChecked='No' limit $per_page, 5") or die(mysql_error());
					while($row=mysql_fetch_array($res))
					{
						$user_id=$row["UserID"];
						$report_id=$row["ReportID"];
						$art_id=$row["ArtID"];
						$report_detail=$row["ReportDetail"];
						...
						<div class="report_detail">
							...
							<div id="rep_desc">
								<p><strong>Reported By :</strong> <a href="check_users.php?User=<?php echo $user_id;?>"><?php echo $user_name;?></a></p><br/>
								<p><strong>Art Name :</strong> <a href="better_view.php?ArtID=<?php echo $art_id;?>"><?php echo $art_name;?></a></p><br/>
								<p><strong>Report Date :</strong> <?php echo $report_date;?></p><br/>
								<p><strong>Report Time :</strong> <?php echo $report_time;?></p><br/>
								<p><strong>Report Detail :</strong></p><textarea disabled> <?php echo $report_detail;?> </textarea><br/>
								
								<form method="post" name="check_report">
									
									<input type="submit" name="checked" value="Report Checked"/>
									
									<?php
									
										if(isset($_POST["checked"])){
											
											$query = "UPDATE Reports SET ReportChecked='Checked' WHERE ReportID='$report_id'";
											$res = mysql_query($query, $conn);
											 ...
											 echo "<script type='text/javascript'>
												window.location='check_reports.php';
												</script>";
										}
					...
					$res1=mysql_query("Select * From Reports");
