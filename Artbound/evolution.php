...
<?php
	...
	if($rows==1){
		while($fetch=mysql_fetch_assoc($result)){
			$evolution=$fetch['ArtboundEvolution'];
...
<?php
	...
	if(isset($_POST['done'])){
		...
		$query = "Update User_Guide Set ArtboundEvolution = '$evolution2' Where ID = 'admin'";
...
<html lang="eng">
	<head>
		<title> Artbound's Evolution </title>
		...
		<main>
			...
			<div class="UsersGuide">
							...
							<form method="post" action="" name="UserGuide">
								...
								<label>Evolution of Artbound</label><br>
								<textarea type="text" id="evolution" name="evolution" maxlength="30000" disabled><?php echo $evolution; ?></textarea>
								...
								<script type='text/javascript'>
										function updateUguide(){
											...
											document.UserGuide.evolution.disabled = false;
											...
											document.UserGuide.evolution.style.border = "2px solid #9E9E9E";
											document.UserGuide.evolution.style.background = "#FFFFFF";
										}
								...
								<script type='text/javascript'>
										function validate(){
											...
											var aguide = document.UserGuide.evolution;
