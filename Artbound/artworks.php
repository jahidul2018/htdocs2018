...
<html lang="eng">
	<head>
		<title> Artworks : <?php echo $first_name." ".$last_name;?> </title>
			...
			<div class="upload_art">
				...
				?>
					<div id="sidebar6">
						<ul id="mcd-menu2">
							<li>
								<a href="art_owner.php?UserID=<?php echo $user_id?>">
							...
							<li>
								<a href="artworks.php?UserID=<?php echo $user_id?>"  class="active">
					...
					<div id="upload">
						...
						<div class="gallery2">
							...
							<?php
								...
								$res=mysql_query("SELECT * FROM Art WHERE UserID='$user_id' AND AdminClearance='Allowed' limit $per_page, 12") or die(mysql_error());
								...
								$res1=mysql_query("Select * From art  Where UserID='$user_id' AND AdminClearance='Allowed'");
