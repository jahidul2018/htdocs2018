...
?>
                    <tr>
                        ...
                        <td><input type="number" name="qty" value="" size="3" min="1" /></td>
                ...
                <tr>
                    ...
                    <td><a href="checkout.php" style=" color:#000;">Checkout!</a></td>
                </tr>
	...
	?>
        ...
        <h1 style="color:#000; padding-top:30px; text-align:center;">&copy; 2017 - By Www.jahidulalammishuk.com</h1>
