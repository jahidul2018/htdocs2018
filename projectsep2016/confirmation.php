...
<a href="logout.php" class="button">Log Out</a>
	...
	<center>
		<h1><a href="userdetails.php">USER DETAILES </a></h1><br />
		</center>
...
<?php 
		...
		$query="select* from order_product where confirm_by_user='1' and confirm_by_admin='1'";
			...
			if(mysql_num_rows($result)>0){
				while($row=mysql_fetch_array($result)){
					...
					echo"<div class=divbuttom><p class=delete><a href='confirmation.php?operation=delete&p_id=".$row['p_id']."'>CONFIRM</a></p></div>";
				...
				if(isset($_GET['operation'])){
					if($_GET['operation']=="delete"){
						$query="UPDATE venue SET post_availality='2' where p_id=".$_GET['p_id'];
							if(mysql_query($query)){
								echo"<center>Recored Confirm!";
								echo"<h1>Your booking has been confirm !</h1><br />";
								echo"<h1> Customer care will contact with You</h1><br /></center>";
		}
			}
	...
	<?php 
		...
		$query="select* from order_productdate where confirm_by_user='1' and confirm_by_admin='1'";
			...
			if(mysql_num_rows($result)>0){
				...
				if(isset($_GET['operation'])){
					if($_GET['operation']=="delete"){
						$query="UPDATE date SET post_availality='2' where dateid=".$_GET['p_id'];
							if(mysql_query($query)){
	...
	<div id="page-wrap">
		...
		<br /><br />
		<center>
		<h1><a href="#">ALL confirmed booked</a></h1><br />
		</center>
