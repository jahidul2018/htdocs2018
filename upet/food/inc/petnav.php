				...
				<ul class="sf-menu">
					...
					<li>
						...
						<ul>
							...
							<li><a href="pet1.php">Dog</a></li>
							<li><a href="pet2.php">Cat</a></li>
					...
					<li>
						...
						<ul>
							...
							<li><a href="http://localhost/upet/food/logout.php">Logout</a>
							</li>
						</ul>
					</li>
				...
				?>
					<div class="s-cart">
						...
						<div class="cart-info">
							...
							<?php
								...
								foreach ($cart as $key => $value) {
									...
									$navcartsql = "SELECT * FROM pets WHERE id=$key";
							...
							<div class="ci-item">
								...
								<div class="ci-item-info">
									<h5><a href="petsingle.php?id=<?php echo $navcartr['id']; ?>"><?php echo substr($navcartr['petname'], 0 , 20); ?></a></h5>
									<!-- <p><?php echo $value['quantity']; ?> x $ <?php echo $navcartr['price']; ?>.00/-</p> -->
									<div class="ci-edit">
										<!-- <a href="#" class="edit fa fa-edit"></a> -->
										<a href="petdelcart.php?id=<?php echo $key; ?>" class="edit fa fa-trash"></a>
									</div>
								</div>
							</div>
							<?php 
						...
						?>
							...
							<div class="cart-btn">
								<!--change in here-->
								<a href="petcart.php">View Bag</a>
								<a href="petcheckout.php">Checkout</a>
							</div>
						</div>
					</div>
					<!-- <div class="s-search">
