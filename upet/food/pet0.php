			...
			<div class="container">
				<div class="row">
					<div class="page_header text-center">
						<!-- <h3>Purchase Food</h3> -->
						<p>Save Your Money. Adoption Is Free!</p>
					</div>
					<div class="col-md-12">
						<div class="row">
									...
									<div class="product">
										<div class="product-thumb">
											...
											<div class="product-overlay">
												<span>
												<a href="petsingle.php?id=<?php echo $r['id']; ?>" class="fa fa-link"></a>
										...
										<h2 class="product-title"><a href="petsingle.php?id=<?php echo $r['id']; ?>"><?php echo $r['petname']; ?></a></h2>
