			<div class="menu-wrap">
				...
				<ul class="sf-menu">
					<li>
						<a href="http://localhost/upet/index.html">Home</a>
					</li>
					<li>
					...
					<li>
						...
						<div class="mobnav-subarrow"><i class="fa fa-plus"></i></div>
						<ul>
							<li><a href="http://localhost/upet/ecomphp/my-account.php">My Orders</a></li>
							<li><a href="http://localhost/upet/ecomphp/edit-address.php">Update Address</a></li>
							<li><a href="http://localhost/upet/ecomphp/logout.php">Logout</a></li>
						</ul>
					</li>
						...
						<div class="cart-info">
							...
							<div class="ci-item">
								...
								<div class="ci-item-info">
									...
									<p><?php echo $value['quantity']; ?> x BDT <?php echo $navcartr['price']; ?>.00/-</p>
									<div class="ci-edit">
							...
							<div class="ci-total">Subtotal: BDT <?php echo $total; ?>.00/-</div>
							<div class="cart-btn">
