...
if ($_SERVER['REQUEST_METHOD']=='POST') {
        ...
        if ($pocket=="Select Pocket" || $sleeve=="Select Sleeve" || $front=="Front" || $back=="Back Pleats" || $bottom=="Bottom" || $cuffs=="Select Cuffs" || $collar=="Collar" || $neck=="" || $chest=="" || $waist=="" || $hip=="" || $length=="" || $soulder=="" || $sleeve=="" || $fitness=="")
            {
                echo "<span style='color:red; font-size:25px; float:left;'>Field Must Not Be Empty !!</span> <br> <br>" ;
                        ...
                        {echo "<span style='color:red; font-size:25px'>Measurment field must not be alphanumeric</span> <br> <br>";
   ...
   <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="grid_10">
            <div class="block" style="color: white;">
                 <input type="checkbox" name="check_list[]" value="none" checked="">none of them  
                 <input type="checkbox" name="check_list[]" value="design only" checked="">design only           
