...
if ($_SERVER['REQUEST_METHOD']=='POST') {
    ...
    $design_id='des'.substr(strtoupper(md5(rand())),6,6);
        ...
        if ($pocket=="Select Pocket" || $sleeve=="Select Sleeve" || $front=="Front" || $back=="Back Pleats" || $bottom=="Bottom" || $cuffs=="Select Cuffs" || $collar=="Collar" || $neck=="" || $chest=="" || $waist=="" || $hip=="" || $length=="" || $soulder=="" || $sleeve=="" || $fitness=="")
            {
                echo "<span style='color:red; font-size:25px; float:left;'>Field Must Not Be Empty !!</span>";

            }elseif (ctype_alpha($neck) || ctype_alpha($chest) || ctype_alpha($waist) || ctype_alpha($hip) || ctype_alpha($length) || ctype_alpha($soulder) || ctype_alpha($sleeve) )

                        {echo "<span style='color:red; font-size:25px'>Measurment field must not be alphanumeric</span>";
                   ...
                   // echo "<span class='error'> measurment, phone postal code, customer field Must Be numeric!!</span>";
                    ...
                    echo "<span style='color:red; font-size:25px'>Thanks for order</span>"
                        ...
                        if (!$insertcust) {
                            ...
                            $insertmesurment= "INSERT INTO shirt_measurment(customer_email, neck, chest, waist, hip, length, sleeve, fitness) VALUES('$customer_email', '$neck', '$chest', '$waist', '$hip', '$length', '$sleeve', '$fitness')";
                                ...
                                echo "<script>alert('measurment data not inserted');</script>"; exit();
                                    ...
                                    $insertdesign= "INSERT INTO shirt_design(design_id, customer_email, product_id, pocket, sleeve, front, back_pleats, bottom, collar, cuffs, other) VALUES('$design_id', '$customer_email', '$product_id', '$pocket', '$sleeve', '$front', '$back', '$bottom', '$collar', '$cuffs', '$other_list')";
   ...
   <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="grid_10">
            <div class="block" style="color: black;">
                    <input type="checkbox" name="check_list[]" value="only design, " checked="checked">only design
                    <input type="checkbox" name="check_list[]" value="none" checked="checked">none of them          
                ...
                <div class="block">
                    ...
                    <table class="form">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="product_id" value="<?php echo $product_id;?>" class="small" readmore />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="radio" name="fitness" value="body fit" style="color: white;" checked="checked"> Body Fit
                ...
                <div class="block">
                    ...
                    $size= session::get("size"); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" value="<?php echo $customer_name;?>" class="small" readmore/>
                            </td> 
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="email" value="<?php echo $customer_email;?>" class="small" readmore/>
                            </td>
                        </tr>
                         ...
                         <tr>
                            ...
                            <td>
                                <input type="text" value="<?php echo $phone;?>" class="small" readmore/>
                            </td>
                        </tr>
                         ...
                         <tr>
                            ...
                            <td>
                                <input type="text" value="<?php echo $city;?>" class="small" /> 
                            </td>
                        </tr>
                          ...
                          <tr>
                            ...
                            <td>
                                <input type="text" value="<?php echo $postal_code;?>" class="small" readmore/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                               <textarea style="width:300px; height:150px;"> <?php echo $address;?>"</textarea>
                            </td>
                        </tr>
                        <tr>
                            <td></td>
